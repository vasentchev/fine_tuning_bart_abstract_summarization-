...
trainer.save_model("./plots_bart_Large/rep_model_train")  # sauvegarde du modèle
tokenizer.save_pretrained("./plots_bart_Large/rep_tokenizer_train")  # Sauvegarde du tokenizer
...
def plot_training_metrics(log_history):
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig("plots_bart_Large/train_val.png")
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig("plots_bart_Large/rouge_scores.png")
    ...
    plt.tight_layout()
    plt.savefig("plots_bart_Large/Comparison_val_score.png")
    plt.show()
