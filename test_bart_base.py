...
model_path = "./save_fine_tuning/rep_model_fine_tuning_BART_base"
tokenizer_path = "./save_fine_tuning/rep_tokenizer_fine_tuning_BART_base"
...
if __name__ == "__main__":
    ...
    plt.tight_layout()
    plt.savefig("plots_bart_Base/scores_rouge_bart_base.png")  # <-- fichier PNG sauvegardé ici
    plt.close()
